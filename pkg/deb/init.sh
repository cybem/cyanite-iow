...
# Default-Stop:      0 1 6
# Short-Description: Cyanite server
# Description:       The Cyanite monitoring system's event processor.
### END INIT INFO
...
DESC="Cyanite"
NAME=cyanite
DAEMON=/usr/bin/cyanite
DAEMON_ARGS="/etc/cyanite/cyanite.yaml"
DAEMON_USER=cyanite
...
do_stop()
{
  ...
  # sleep for some time.
  start-stop-daemon --stop --quiet --oknodo --retry=0/180/KILL/5 --exec $DAEMON
  [ "$?" = 2 ] && return 2
